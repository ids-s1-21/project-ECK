...
```{r speed-of-constructors, echo = FALSE, warning = FALSE}
f1merged_hybrid %>%
  filter(constructorname %in% key_teams) %>%
  ggplot(aes(x = position, y = constructorname,
             fill = constructorname,
...
<font size='5'>
There is a pretty big cluster at the top 5 positions.
</font>
...
<font style="font size='4';color:white;">
This text is just to separate the tables
</font>
