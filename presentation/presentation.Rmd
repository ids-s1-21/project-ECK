...
```{r poles-wins-summary-statistics-1, echo = FALSE} 
f1merged_hybrid %>%
  filter(position == 1) %>%
...
```{r poles-wins-summary-statistics-2, echo = FALSE}
...
<font size='5'>
Overall, speed does affect a drivers performance - a faster car can lead to a better qualifying race, which can result in a better finishing position.
</font>
...
<font size = '6'>
We were not able to separate mechanical from non-mechanical retirements (like collisions) in our analysis - this is a limitation due to the amount of data we are provided.
</font>
...
<font size='5'>
This doesn't seem like an accurate fit, but if we look at the summary statistics and the residual plot...
</font>
...
* A skilled driver (this is beyond the scope of this project)
