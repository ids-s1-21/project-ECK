...
author: <font size='8'>ECK <br>Eila Tether, Callum Stewart & Kai Morgan</font>
...
## To begin we must first prove that Mercedes-AMG Petronas F1 Team are the best in the current hybrid era (2014-2020)

# Mercedes Success
```{r hybrid_era, echo = FALSE}
hybrid_era <- (2014:2020)
```

```{r Mercedes success, echo = FALSE}
...
```{r datasets-and-variables, message = FALSE, echo=FALSE}
key_teams <- c("Ferrari", 
               "McLaren",
               "Mercedes",
               "Red Bull",
