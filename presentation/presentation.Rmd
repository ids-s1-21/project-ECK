...
```{r qualifying_vs_finishing_top_5_model_2, echo = FALSE}
...
<font size='5'>
20.9% of the variation in finishing position can be explained by this model.
</font>

##

<font size='5'>
Residuals - Qualifying vs Finishing position (Top 5 Qualifiers)
</font>
...
<font size='5'>
Our model without top 5 qualifiers predicts that, on average, for every 1 place further back a driver qualifies they will finish 0.537 places further back.
</font>

```{r qualifying_vs_finishing_rest_model_2, echo = FALSE}
...
<font size='5'>
33% of the variation in finishing position can be explained by this model.
</font>
...
<font size='10'>
Again there appears to be a negative linear relationship here. Teams with marginally quicker median stop times would be expected to score significantly more points across an entire season.
</font>

<font size='10'>
What if we were to combine our previous models and try to predict total points per season using *multiple* predictor variables?
</font>
