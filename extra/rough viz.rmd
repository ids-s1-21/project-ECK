...
```
 - Note: pit stop times exceeding one minute have been excluded from this visualization as outlying data points that make it far less readable. All of the data points are included in the summary statistics above