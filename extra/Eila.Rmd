...
f1merged_hybrid %>%
  ...
  theme(legend.position = "none")
```
This visualisation shows us that drivers using Willams' or McLaurens tend to have less wins than other constructors, and Mercedes again shows a strong lead. This again suggests that having Mercedes as the constructor may lead to a better performance.
